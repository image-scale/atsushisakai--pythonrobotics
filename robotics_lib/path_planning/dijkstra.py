"""
Grid-based Dijkstra's algorithm for path planning.

Finds the shortest path on a 2D grid with obstacles.
"""
import math
...
class GridPlanner:
    ...
    def find_path(self, start_x, start_y, goal_x, goal_y):
        ...
        while open_nodes:
            current_key = min(open_nodes, key=lambda k: open_nodes[k].cost)
...
class _GridNode:
    """Internal node class for grid search."""
